...
const TaskCard: React.FC<TaskCardProps> = ({ task, onEdit, onClick }) => {
  ...
  return (
    <div 
      ...
      className={cn(
        "group relative bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer",
        task.isCompleted && "bg-gray-50/50 opacity-70",
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <h3 
              className={cn(
                "text-base font-medium text-gray-900 transition-all",
          ...
          <div className="mt-3 flex items-center gap-3 text-xs text-gray-400">
            {category && (
              <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-gray-50 text-gray-600 font-medium">
        ...
        <div className="relative">
          <button 
            ...
            className="p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-md opacity-0 group-hover:opacity-100 transition-opacity focus:opacity-100"
          >
            <MoreVertical className="w-4 h-4" />
          </button>
          
          {showMenu && (
            <div className="absolute right-0 top-8 w-32 bg-white rounded-lg shadow-lg border border-gray-100 py-1 z-10 animate-in fade-in zoom-in-95 duration-100">
              <button 
