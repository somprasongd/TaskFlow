...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen, className }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <aside className={cn(
        "fixed lg:sticky top-0 left-0 z-50 h-screen w-[260px] bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 ease-in-out lg:translate-x-0 shadow-lg lg:shadow-none",
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-100 dark:border-gray-700">
          <div className="flex items-center gap-2 text-primary font-bold text-xl cursor-pointer" onClick={() => handleNavigate('/')}>
            ...
            <span className="text-gray-900 dark:text-white">TaskFlow</span>
          </div>
        </div>
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <span className={cn(
                ...
                filter.categoryId === 'all' && !isActive('calendar')
            ...
            <div className="flex items-center justify-between px-3 mb-2">
              ...
              <div className="flex items-center gap-1">
                ...
                <button 
                  ...
                  className="text-gray-400 hover:text-primary transition-colors p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700"
                  title="Add Category"
                >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          <div 
            className="flex items-center gap-3 px-2 mb-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-lg transition-colors"
          ...
          <div className="grid grid-cols-2 gap-2">
            <button 
              onClick={() => handleNavigate('/profile')}
              className="flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors"
            >
            ...
            <button 
              onClick={logout}
              className="flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg transition-colors"
            >
